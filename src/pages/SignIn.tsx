          ...
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-4 pt-4">
                ...
                <Button type="button" variant="outline" disabled={loading} className="w-full border-border font-semibold text-foreground hover:text-primary hover:border-primary/30" onClick={handleGoogleSignIn}>
